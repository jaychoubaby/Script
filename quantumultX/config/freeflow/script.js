// 教程:https://xlangzhong.notion.site/_-aed29d5f612f4aa9baf2fbf01aeea704
// 腾讯大王卡:tx.flv.huya.com
// 腾讯大王卡:short.weixin.qq.com
// 大王卡腾讯视频:puui.qpic.cn
// http://www.xn--9kqv03dn4b.xyz/weizhuang.html

async function operator(proxies = []) {
  const _ = lodash

  const host = _.get($arguments, 'host') || 'tx.flv.huya.com'
  const hostPrefix = _.get($arguments, 'hostPrefix') || '[腾讯混淆]'
